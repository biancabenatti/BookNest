...
async function carregarLivros() {
    try {
      const res = await fetch('https://book-nest-mauve-delta.vercel.app/api/livros');
...
function editarDescricao(idLivro) {
    ...
    btnSalvar.onclick = async function() {
        ...
        try {
            ...
            await fetch(`https://book-nest-mauve-delta.vercel.app/api/livros/${idLivro}`, {
                method: 'PUT',
                headers: {
...
async function removerLivro(id) {
    ...
    try {
        const res = await fetch(`https://book-nest-mauve-delta.vercel.app/api/livros/${livro._id}`,{
            method: 'DELETE',
        });
